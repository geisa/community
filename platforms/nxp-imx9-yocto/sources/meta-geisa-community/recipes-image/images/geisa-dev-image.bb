...
add_empty_root_password_note () {
    echo "Type 'root' to login with superuser privileges (no passwd).\\n" >> ${IMAGE_ROOTFS}/etc/issue
}
...
# The FRDM boards use the NXP IW612 SDIO/UART module. This exact package is
...
IMAGE_INSTALL += " \
    ...
    ${GEISA_ACCELERATOR_PACKAGEGROUP} \
    ${@bb.utils.contains('GEISA_ACCELERATOR', 'ethosu', 'geisa-nxp-ethosu-tflite-profile', '', d)} \
