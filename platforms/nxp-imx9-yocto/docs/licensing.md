...
The i.MX95 Neutron image includes separately licensed NXP runtime, driver, and
firmware packages. The Community smoke-test package includes the qualification
fixture, but that packaging does not change the license or notice obligations
for the included model or NXP components.
