...
BitBake. The URL, filename, tag, and SHA-256 are in
...
the wheel, but a release WIC containing the generated profile should undergo the
SPDX and package license review, including the NXP BSP and bundled multimedia
components, before binary redistribution.
